  ...
  return (
    <section className="relative z-10 px-6 py-24">
      ...
      <div className="mx-auto mt-16 grid max-w-5xl grid-cols-2 gap-5 sm:gap-8 md:grid-cols-3">
        ...
        <PhotoFrame rotate="-2deg" caption="O seu lindo cabelo vermelho" src="/nicolly-cabelo.jepeg" alt="Nicolly jogando cartas" />
        <PhotoFrame rotate="1deg" caption="esse corpinho que eu amo" src="/nicoly-corpo.jpeg" alt="A gente juntos" className="md:mt-6" />
      </div>
    </section>
  )
}
